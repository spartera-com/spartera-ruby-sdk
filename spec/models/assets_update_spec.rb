...
# Unit tests for OpenapiClient::AssetsUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AssetsUpdate do
  #let(:instance) { OpenapiClient::AssetsUpdate.new }

  describe 'test an instance of AssetsUpdate' do
    it 'should create an instance of AssetsUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AssetsUpdate)
    end
  end
