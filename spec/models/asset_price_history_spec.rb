...
# Unit tests for OpenapiClient::AssetPriceHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AssetPriceHistory do
  #let(:instance) { OpenapiClient::AssetPriceHistory.new }

  describe 'test an instance of AssetPriceHistory' do
    it 'should create an instance of AssetPriceHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AssetPriceHistory)
    end
  end
