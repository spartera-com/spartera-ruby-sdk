...
# Unit tests for SparteraApiSdk::EndpointsInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SparteraApiSdk::EndpointsInput do
  #let(:instance) { SparteraApiSdk::EndpointsInput.new }

  describe 'test an instance of EndpointsInput' do
    it 'should create an instance of EndpointsInput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SparteraApiSdk::EndpointsInput)
    end
  end
