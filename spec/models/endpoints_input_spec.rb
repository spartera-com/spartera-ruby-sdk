...
# Unit tests for OpenapiClient::EndpointsInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EndpointsInput do
  #let(:instance) { OpenapiClient::EndpointsInput.new }

  describe 'test an instance of EndpointsInput' do
    it 'should create an instance of EndpointsInput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::EndpointsInput)
    end
  end
