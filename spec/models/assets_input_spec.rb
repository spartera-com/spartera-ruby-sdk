...
# Unit tests for OpenapiClient::AssetsInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AssetsInput do
  #let(:instance) { OpenapiClient::AssetsInput.new }

  describe 'test an instance of AssetsInput' do
    it 'should create an instance of AssetsInput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AssetsInput)
    end
  end
