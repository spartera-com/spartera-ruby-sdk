...
# Unit tests for SparteraApiSdk::EndpointsUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SparteraApiSdk::EndpointsUpdate do
  #let(:instance) { SparteraApiSdk::EndpointsUpdate.new }

  describe 'test an instance of EndpointsUpdate' do
    it 'should create an instance of EndpointsUpdate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SparteraApiSdk::EndpointsUpdate)
    end
  end
