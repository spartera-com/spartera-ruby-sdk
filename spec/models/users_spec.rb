...
# Unit tests for SparteraApiSdk::Users
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SparteraApiSdk::Users do
  #let(:instance) { SparteraApiSdk::Users.new }

  describe 'test an instance of Users' do
    it 'should create an instance of Users' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SparteraApiSdk::Users)
    end
  end
