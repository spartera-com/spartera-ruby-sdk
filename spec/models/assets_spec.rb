...
# Unit tests for SparteraApiSdk::Assets
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SparteraApiSdk::Assets do
  #let(:instance) { SparteraApiSdk::Assets.new }

  describe 'test an instance of Assets' do
    it 'should create an instance of Assets' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SparteraApiSdk::Assets)
    end
  end
  ...
  describe 'test attribute "visibility"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["PRIVATE", "SHARED"])
      # validator.allowable_values.each do |value|
