...
# Unit tests for OpenapiClient::Assets
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Assets do
  #let(:instance) { OpenapiClient::Assets.new }

  describe 'test an instance of Assets' do
    it 'should create an instance of Assets' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Assets)
    end
  end
