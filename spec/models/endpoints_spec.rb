...
# Unit tests for SparteraApiSdk::Endpoints
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SparteraApiSdk::Endpoints do
  #let(:instance) { SparteraApiSdk::Endpoints.new }

  describe 'test an instance of Endpoints' do
    it 'should create an instance of Endpoints' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SparteraApiSdk::Endpoints)
    end
  end
