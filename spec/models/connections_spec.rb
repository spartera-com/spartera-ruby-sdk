...
# Unit tests for OpenapiClient::Connections
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Connections do
  #let(:instance) { OpenapiClient::Connections.new }

  describe 'test an instance of Connections' do
    it 'should create an instance of Connections' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Connections)
    end
  end
