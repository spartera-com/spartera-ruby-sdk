...
# Unit tests for OpenapiClient::Alerts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Alerts do
  #let(:instance) { OpenapiClient::Alerts.new }

  describe 'test an instance of Alerts' do
    it 'should create an instance of Alerts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Alerts)
    end
  end
