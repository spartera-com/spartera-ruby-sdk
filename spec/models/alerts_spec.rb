...
# Unit tests for SparteraApiSdk::Alerts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SparteraApiSdk::Alerts do
  #let(:instance) { SparteraApiSdk::Alerts.new }

  describe 'test an instance of Alerts' do
    it 'should create an instance of Alerts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SparteraApiSdk::Alerts)
    end
  end
