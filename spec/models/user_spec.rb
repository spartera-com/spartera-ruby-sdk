...
# Unit tests for SparteraApiSdk::User
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SparteraApiSdk::User do
  let(:instance) { SparteraApiSdk::User.new }

  describe 'test an instance of User' do
    it 'should create an instance of User' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SparteraApiSdk::User)
    end
  end
