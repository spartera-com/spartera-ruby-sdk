...
> <Array(<CloudProvidersProviderIdStorageEnginesGet200Response>, Integer, Hash)> cloud_providers_provider_id_storage_engines_engine_id_get_with_http_info(provider_id, engine_id)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <CloudProvidersProviderIdStorageEnginesGet200Response>
rescue SparteraApiSdk::ApiError => e
...
> <Array(<CloudProvidersProviderIdStorageEnginesGet200Response>, Integer, Hash)> cloud_providers_provider_id_storage_engines_get_with_http_info(provider_id)
