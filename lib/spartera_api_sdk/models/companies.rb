...
module SparteraApiSdk
  ...
  class Companies
    ...
    def hash
      [date_created, last_updated, company_id, industry_id, country_id, company_name, company_description, company_handle, company_domain, credits_balance, accepted_eula, stripe_account_id, stripe_account_status].hash
    end
