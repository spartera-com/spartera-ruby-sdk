...
module SparteraApiSdk
  class CloudProvidersApi
    ...
    # Get a list of all cloud providers
    # @param [Hash] opts the optional parameters
    # @return [Array<(CloudProvidersGet200Response, Integer, Hash)>] CloudProvidersGet200Response data, response status code and response headers
    def cloud_providers_get_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CloudProvidersGet200Response'
    ...
    # @param provider_id [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CloudProvidersProviderIdGet200Response, Integer, Hash)>] CloudProvidersProviderIdGet200Response data, response status code and response headers
    def cloud_providers_provider_id_get_with_http_info(provider_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CloudProvidersProviderIdGet200Response'
