...
module SparteraApiSdk
  class ConnectionsApi
    ...
    def companies_company_id_connections_connection_id_patch(company_id, connection_id, connections_update, opts = {})
      data, _status_code, _headers = companies_company_id_connections_connection_id_patch_with_http_info(company_id, connection_id, connections_update, opts)
      data
    end
    ...
    def companies_company_id_connections_connection_id_patch_with_http_info(company_id, connection_id, connections_update, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && connections_update.nil?
        fail ArgumentError, "Missing the required parameter 'connections_update' when calling ConnectionsApi.companies_company_id_connections_connection_id_patch"
      end
      # resource path
      local_var_path = '/companies/{company_id}/connections/{connection_id}'.sub('{' + 'company_id' + '}', CGI.escape(company_id.to_s)).sub('{' + 'connection_id' + '}', CGI.escape(connection_id.to_s))
    ...
    def companies_company_id_connections_post(company_id, connections_input, opts = {})
      data, _status_code, _headers = companies_company_id_connections_post_with_http_info(company_id, connections_input, opts)
      data
    end
    ...
    def companies_company_id_connections_post_with_http_info(company_id, connections_input, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && connections_input.nil?
        fail ArgumentError, "Missing the required parameter 'connections_input' when calling ConnectionsApi.companies_company_id_connections_post"
      end
      # resource path
      local_var_path = '/companies/{company_id}/connections'.sub('{' + 'company_id' + '}', CGI.escape(company_id.to_s))
