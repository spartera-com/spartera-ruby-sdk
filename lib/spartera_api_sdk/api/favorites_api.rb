...
module SparteraApiSdk
  class FavoritesApi
    ...
    # @param category [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CompaniesCompanyIdUsersUserIdFavoritesCategoryCategoryGet200Response, Integer, Hash)>] CompaniesCompanyIdUsersUserIdFavoritesCategoryCategoryGet200Response data, response status code and response headers
    def companies_company_id_users_user_id_favorites_category_category_get_with_http_info(company_id, user_id, category, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CompaniesCompanyIdUsersUserIdFavoritesCategoryCategoryGet200Response'
    ...
    def companies_company_id_users_user_id_favorites_favorite_id_patch(company_id, user_id, favorite_id, favorites_update, opts = {})
      data, _status_code, _headers = companies_company_id_users_user_id_favorites_favorite_id_patch_with_http_info(company_id, user_id, favorite_id, favorites_update, opts)
      data
    end
    ...
    def companies_company_id_users_user_id_favorites_favorite_id_patch_with_http_info(company_id, user_id, favorite_id, favorites_update, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && favorites_update.nil?
        fail ArgumentError, "Missing the required parameter 'favorites_update' when calling FavoritesApi.companies_company_id_users_user_id_favorites_favorite_id_patch"
      end
      # resource path
      local_var_path = '/companies/{company_id}/users/{user_id}/favorites/{favorite_id}'.sub('{' + 'company_id' + '}', CGI.escape(company_id.to_s)).sub('{' + 'user_id' + '}', CGI.escape(user_id.to_s)).sub('{' + 'favorite_id' + '}', CGI.escape(favorite_id.to_s))
    ...
    def companies_company_id_users_user_id_favorites_post(company_id, user_id, favorites_input, opts = {})
      data, _status_code, _headers = companies_company_id_users_user_id_favorites_post_with_http_info(company_id, user_id, favorites_input, opts)
      data
    end
    ...
    def companies_company_id_users_user_id_favorites_post_with_http_info(company_id, user_id, favorites_input, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && favorites_input.nil?
        fail ArgumentError, "Missing the required parameter 'favorites_input' when calling FavoritesApi.companies_company_id_users_user_id_favorites_post"
      end
      # resource path
      local_var_path = '/companies/{company_id}/users/{user_id}/favorites'.sub('{' + 'company_id' + '}', CGI.escape(company_id.to_s)).sub('{' + 'user_id' + '}', CGI.escape(user_id.to_s))
