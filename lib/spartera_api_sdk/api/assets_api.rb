...
module SparteraApiSdk
  class AssetsApi
    ...
    # @param company_handle [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(AnalyzeCompanyHandleAssetsAssetSlugGet200Response, Integer, Hash)>] AnalyzeCompanyHandleAssetsAssetSlugGet200Response data, response status code and response headers
    def analyze_company_handle_assets_asset_slug_get_with_http_info(asset_slug, company_handle, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'AnalyzeCompanyHandleAssetsAssetSlugGet200Response'
    ...
    def companies_company_id_assets_asset_id_patch(company_id, asset_id, assets_update, opts = {})
      data, _status_code, _headers = companies_company_id_assets_asset_id_patch_with_http_info(company_id, asset_id, assets_update, opts)
      data
    end
    ...
    def companies_company_id_assets_asset_id_patch_with_http_info(company_id, asset_id, assets_update, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && assets_update.nil?
        fail ArgumentError, "Missing the required parameter 'assets_update' when calling AssetsApi.companies_company_id_assets_asset_id_patch"
      end
      # resource path
      local_var_path = '/companies/{company_id}/assets/{asset_id}'.sub('{' + 'company_id' + '}', CGI.escape(company_id.to_s)).sub('{' + 'asset_id' + '}', CGI.escape(asset_id.to_s))
    ...
    def companies_company_id_assets_post(company_id, assets_input, opts = {})
      data, _status_code, _headers = companies_company_id_assets_post_with_http_info(company_id, assets_input, opts)
      data
    end
    ...
    def companies_company_id_assets_post_with_http_info(company_id, assets_input, opts = {})
      if @api_client.config.debugging
