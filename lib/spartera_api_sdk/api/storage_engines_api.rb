...
module SparteraApiSdk
  class StorageEnginesApi
    ...
    # @param engine_id [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CloudProvidersProviderIdStorageEnginesGet200Response, Integer, Hash)>] CloudProvidersProviderIdStorageEnginesGet200Response data, response status code and response headers
    def cloud_providers_provider_id_storage_engines_engine_id_get_with_http_info(provider_id, engine_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CloudProvidersProviderIdStorageEnginesGet200Response'
