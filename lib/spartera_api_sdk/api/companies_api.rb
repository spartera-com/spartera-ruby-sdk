...
module SparteraApiSdk
  class CompaniesApi
    ...
    # @param company_id [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CompaniesCompanyIdAnalyticsAssetsGet200Response, Integer, Hash)>] CompaniesCompanyIdAnalyticsAssetsGet200Response data, response status code and response headers
    def companies_company_id_analytics_assets_get_with_http_info(company_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CompaniesCompanyIdAnalyticsAssetsGet200Response'
    ...
    # @param company_id [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CompaniesCompanyIdGet200Response, Integer, Hash)>] CompaniesCompanyIdGet200Response data, response status code and response headers
    def companies_company_id_get_with_http_info(company_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CompaniesCompanyIdGet200Response'
    ...
    # @param [Hash] opts the optional parameters
    # @return [CompaniesCompanyIdPatch200Response]
    def companies_company_id_patch(company_id, companies_update, opts = {})
      data, _status_code, _headers = companies_company_id_patch_with_http_info(company_id, companies_update, opts)
      data
    end
    ...
    # @param companies_update [CompaniesUpdate] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CompaniesCompanyIdPatch200Response, Integer, Hash)>] CompaniesCompanyIdPatch200Response data, response status code and response headers
    def companies_company_id_patch_with_http_info(company_id, companies_update, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && companies_update.nil?
        fail ArgumentError, "Missing the required parameter 'companies_update' when calling CompaniesApi.companies_company_id_patch"
      end
      # resource path
      local_var_path = '/companies/{company_id}'.sub('{' + 'company_id' + '}', CGI.escape(company_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CompaniesCompanyIdPatch200Response'
